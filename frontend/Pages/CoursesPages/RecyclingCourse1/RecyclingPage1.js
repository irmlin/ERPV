    ...
    async function playBackgroundMusic() {
      try {
        ...
        await backgroundMusic.loadAsync(
          require("frontend/assets/music/Character_voiceover/audio1.mp3")
        );
    ...
    >
      <ScrollView>
        ...
        <View style={styles.container}>
          <Image
            source={require("frontend/assets/icons/recycling_sign.png")}
            style={{
              width: 150,
              height: 150,
              marginTop: 25,
          ...
          <Text style={styles.centeredText}>
            Labas! Šioje pamokėlėje pasimokysime apie tai kaip yra ženklinamos
            rūšiavimui tinkamos pakuotės bei ką apie jas turėtum žinoti.
          </Text>
