    ...
    async function playBackgroundMusic() {
      try {
        ...
        await backgroundMusic.loadAsync(
          require("frontend/assets/music/Character_voiceover/audio3.mp3")
        );
    ...
    >
      <ScrollView>
        ...
        <View style={styles.container}>
          <Image
            source={require("frontend/assets/rusiavimo_kodas.png")}
            style={{
              width: "100%",
              height: 200,
              marginTop: 25,
          ...
          <Text style={styles.centeredText}>
            Jeigu ant pakuotės matai keletą rūšiuojamos pakuotės simbolių, tai
            reiškia, jog ji yra sudaryta iš skirtingų rūšių atliekų, tad tokią
            pakuotę reikia kruopščiai atskirti ir atitinkamai surūšiuoti
          </Text>
