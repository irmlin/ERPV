    ...
    async function playBackgroundMusic() {
      try {
        ...
        await backgroundMusic.loadAsync(
          require("frontend/assets/music/Character_voiceover/audio5.mp3")
        );
    ...
    >
      <ScrollView>
        ...
        <View style={styles.container}>
          <Image
            source={require("frontend/assets/backgrounds/course_done.png")}
            style={{
              width: "100%",
              height: 150,
              marginTop: 25,
          ...
          <Text style={styles.centeredText}>
            Šiai įvadinei pamokėlei tiek. Tikiuosi tau dabar aiškiau kaip reikia
            ieškoti informacijos apie pakuotės rūšiavimą. Džiaugiuosi tavimi!
          </Text>
          ...
          >
            <Text style={styles.buttonText}>Baigti pamokėlę</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
